    ...
    vida: [
      {
        ...
        desc: "proteção financeira para familiares de colaboradores em caso de imprevistos;",
      },
      {
        title: "Seguro Saúde Empresarial",
        desc: "planos de saúde corporativos para colaboradores e seus dependentes;",
      },
      {
        title: "Seguro de Acidentes de Trabalho",
        desc: "cobertura para acidentes ocorridos durante a atividade profissional;",
      },
      {
        title: "Seguro de Doenças Graves Empresarial",
        desc: "proteção financeira em caso de diagnóstico de doenças críticas em colaboradores;",
      },
    ],
    "nao-vida": [
      {
        title: "Seguro Patrimonial",
        desc: "proteção do patrimônio empresarial contra incêndio, roubo e desastres naturais;",
      },
      {
        title: "Seguro de Responsabilidade Civil Empresarial",
        desc: "proteção contra danos involuntários causados a clientes, fornecedores ou terceiros;",
      },
      {
        title: "Seguro de Frota",
        desc: "cobertura para veículos da empresa contra acidentes, roubo e incêndio;",
      },
      {
        title: "Seguro de Transporte de Cargas",
        desc: "proteção contra perdas e danos de mercadorias durante o transporte;",
      },
    ],
  };
  ...
  return (
    <section className="relative bg-[var(--background)] text-[var(--foreground)] overflow-hidden py-16 md:py-24 lg:py-32">
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        >
          <Image
            src={activeTab === "vida" ? "/bg/danos.jpg" : "/bg/cargas.jpg"}
...
export default EnterpriseServicesInfo;
