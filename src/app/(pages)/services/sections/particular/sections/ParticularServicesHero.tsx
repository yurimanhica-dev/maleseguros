    ...
    <section className="relative h-screen max-h-[700px] overflow-hidden">
      ...
      <div className="relative mt-14 z-10 h-full flex items-center">
        ...
        >
          ...
          >
            Oferecemos soluções completas para garantir sua tranquilidade e
            segurança no dia a dia. Nossos seguros particulares são pensados
            para proteger sua vida, saúde, bens e viagens, com planos flexíveis
            que se adaptam às suas necessidades e ao seu orçamento.
          </motion.p>
...
export default ParticularServicesHero;
