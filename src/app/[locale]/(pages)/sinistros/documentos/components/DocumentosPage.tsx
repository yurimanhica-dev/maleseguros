...
import { documentos } from "@/app/[locale]/utils/types";
import {
  Select,
  SelectContent,
  SelectItem,
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto c-space">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold uppercase text-foreground mb-4">
              Central de <span className="text-primary">Documentos</span>
            </h1>
